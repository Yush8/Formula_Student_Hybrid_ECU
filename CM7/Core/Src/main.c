...
/* USER CODE END Boot_Mode_Sequence_2 */
  ...
  Events_Init();     /* event recorder: seed the watched signals before the first step */
  ...
  while (1)
  {
	...
	if (Sched_StepDue()) {           /* exact 100 Hz tick from TIM6 (see scheduler.h) */
		Model_Step();
		Sched_StepDone();            /* stop the step stopwatch (loop-headroom stats) */
		Events_Poll();               /* emit #E for any discrete signal that just changed */
	}
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, External_Signal_1_Pin|External_Signal_2_Pin|External_Signal_3_Pin|External_Signal_4_Pin
                          |AIR_Sink_Pin|Precharge_Sink_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, User_LED_1_Pin|User_LED_2_Pin|User_LED_3_Pin|User_LED_4_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(IMU_CS_GPIO_Port, IMU_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : SDC_Monitor_Pin */
  GPIO_InitStruct.Pin = SDC_Monitor_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(SDC_Monitor_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : AIR_LED_Pin Precharge_LED_Pin SDC_Monitor_LED_Pin MCU_Active_Pin
                           External_Signal_1_Pin External_Signal_2_Pin External_Signal_3_Pin External_Signal_4_Pin
                           AIR_Sink_Pin Precharge_Sink_Pin */
  GPIO_InitStruct.Pin = AIR_LED_Pin|Precharge_LED_Pin|SDC_Monitor_LED_Pin|MCU_Active_Pin
                          |External_Signal_1_Pin|External_Signal_2_Pin|External_Signal_3_Pin|External_Signal_4_Pin
                          |AIR_Sink_Pin|Precharge_Sink_Pin;
